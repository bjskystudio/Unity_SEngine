...
require "Core.Common.Tools.StringUtil"
require "Core.Common.Tools.LuaUtil"

require "Core.Common.Tools.serpent"
require "Core.Common.cjson.json"
...
local inputConfigPath = CS.UnityEngine.Application.dataPath .. "/Config/TxtConfig"
local outConfigPath = CS.UnityEngine.Application.dataPath .. "/Res/LuaScript/LuaConfig/Gen"
