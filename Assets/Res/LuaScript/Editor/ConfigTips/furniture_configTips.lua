...
---@field public Effects_type number @升级效果（1家具 2墙 3地板）
...
---@field public position number[][] @排序位置
---@field public usedrange number[][] @交互点（紫色）
---@field public direction number[] @朝向
---@field public excursion number[][] @交互点偏移
---@field public range number[][] @站立点（黄色）
---@field public coinrange number[][] @金币掉落点（粉色）
---@field public queue number[][] @排队点（蓝色）
