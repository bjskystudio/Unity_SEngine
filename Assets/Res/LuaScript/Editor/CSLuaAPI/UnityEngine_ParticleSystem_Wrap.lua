...
---@field public lifetimeByEmitterSpeed UnityEngine.ParticleSystem.LifetimeByEmitterSpeedModule
...
---@param vertexBuffersCount int32
---@param indexBuffersCount int32
