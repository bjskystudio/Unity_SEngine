...
---@field public freeformStretching System.Boolean
---@field public rotateWithStretchDirection System.Boolean
---@field public mesh UnityEngine.Mesh
---@field public meshCount int32
---@field public activeVertexStreamsCount int32
---@field public supportsMeshInstancing System.Boolean
local ParticleSystemRenderer = {}

---@return int32
function ParticleSystemRenderer:GetMeshes() end
