...
return _G.ConstClass("game_config",{
    Initial_resources = { Key = "Initial_resources", Desc = "初始金币、钻石、人气值、加速时间（s）", paramNum = 0, paramNumArr = {}, paramNumArrs = { { 1000001, 100 }, { 1000002, 50 }, { 1000003, 0 }, { 1000004, 900 } }, paramStr = "" },
    Res_GoldAutoRaise = { Key = "Res_GoldAutoRaise", Desc = "挂机金币收益每秒", paramNum = 10, paramNumArr = {}, paramNumArrs = {}, paramStr = "" },
    Res_GoldStart = { Key = "Res_GoldStart", Desc = "开始金币", paramNum = 0, paramNumArr = { 100 }, paramNumArrs = {}, paramStr = "" },
    Res_DiamondStart = { Key = "Res_DiamondStart", Desc = "开始钻石", paramNum = 0, paramNumArr = { 10000 }, paramNumArrs = {}, paramStr = "" },
    Res_PopularStart = { Key = "Res_PopularStart", Desc = "开始人气", paramNum = 0, paramNumArr = { 0 }, paramNumArrs = {}, paramStr = "" },
    ...
    Diamond_Upgreade_Time = { Key = "Diamond_Upgreade_Time", Desc = "钻石升级，1钻石等于多少加速", paramNum = 30, paramNumArr = {}, paramNumArrs = {}, paramStr = "" },
    ...
    client_wayout = { Key = "client_wayout", Desc = "顾客室外消失点", paramNum = 0, paramNumArr = {}, paramNumArrs = { { -2, -53 } }, paramStr = "" },
