...
namespace UniRx
{
    ...
    public static partial class ObservableExtensions
    {
        ...
        public static IDisposable Subscribe<T>(this IObservable<T> source, CompositeDisposable compositeDisposable, Action<T> onNext)
        {
            ...
            {
                return source.Subscribe(Observer.CreateSubscribeObserver(onNext, Stubs.Throw, Stubs.Nop)).AddTo(compositeDisposable);  
            }

        }

        public static IDisposable Subscribe<T>(this IObservable<T> source, CompositeDisposable compositeDisposable, Action<T> onNext, Action<Exception> onError)
        {
            if (compositeDisposable == null)
            {
            ...
            {
                return source.Subscribe(Observer.CreateSubscribeObserver(onNext, onError, Stubs.Nop)).AddTo(compositeDisposable);            
            }
        }

        public static IDisposable Subscribe<T>(this IObservable<T> source, CompositeDisposable compositeDisposable, Action<T> onNext, Action onCompleted)
        {
            if (compositeDisposable == null)
            {
            ...
            {
                return source.Subscribe(Observer.CreateSubscribeObserver(onNext, Stubs.Throw, onCompleted)).AddTo(compositeDisposable);            
            }
        }

        public static IDisposable Subscribe<T>(this IObservable<T> source,  CompositeDisposable compositeDisposable, Action<T> onNext, Action<Exception> onError, Action onCompleted)
        {
            if (compositeDisposable == null)
            {
            ...
            {
                return source.Subscribe(Observer.CreateSubscribeObserver(onNext, onError, onCompleted)).AddTo(compositeDisposable);                 
            }
        }
