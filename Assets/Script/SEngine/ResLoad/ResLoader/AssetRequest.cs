...
namespace SEngine
{
    public class AssetRequest
    {
        ...
        public void Load(SResAssetBundle ab, string assetName, Type type, bool isSync, bool isAll = false)
        {
            if(!IsComplete)
            {
                ResLoadManager.Instance.StartCoroutine(CoLoad(ab, assetName, type, isSync, isAll));
            }
        }

        private IEnumerator CoLoad(SResAssetBundle hAB, string assetName, Type type, bool isSync, bool isAll = false)
        {
