...
public class UINodeSingleton
{
    ...
    public UnityEngine.Object GetUINodeType(Transform trans, string keyname)
    {
        ...
        switch (type)
        {
            ...
            //    break;
            case "sbtn":
                obj = trans.GetComponent<SButton>();
                break;
            case "stog":
                obj = trans.GetComponent<SToggle>();
                break;
            case "img":
                obj = trans.GetComponent<Image>();
                break;
            case "simg":
                obj = trans.GetComponent<SImage>();
                break;
            case "rawimage":
            ...
            case "grid":
                ...
                break;
            case "list":
                obj = trans.GetComponent<SuperScrollView.LoopListView2>();
                break;
            case "textmeshpro":
