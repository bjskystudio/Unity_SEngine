...
namespace XLua.CSObjectWrap
{
    ...
    public class SuperScrollViewLoopListView2Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 28, 21, 9);
        ...
        static int _m_ResetListView(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to SuperScrollView.LoopListView2.ResetListView!");
        ...
        static int _m_SetSnapTargetItemIndex(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to SuperScrollView.LoopListView2.SetSnapTargetItemIndex!");
