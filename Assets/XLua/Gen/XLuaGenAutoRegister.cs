...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(SEngine.XLuaManager), SEngineXLuaManagerWrap.__Register);
...
namespace XLua
{
	...
	internal partial class InternalGlobals
    {
		...
		delegate void __GEN_DELEGATE0( UnityEngine.Transform target);
		
		delegate void __GEN_DELEGATE1( UnityEngine.Component target);
		
		delegate void __GEN_DELEGATE2( UnityEngine.GameObject target);
	    ...
	    static InternalGlobals()
		{
		    extensionMethodMap = new Dictionary<Type, IEnumerable<MethodInfo>>()
			{
				...
				{typeof(UnityEngine.Transform), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE0(SEngine.UnityObjectExtends.ResetPRS)
				...
				{typeof(UnityEngine.Component), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE1(SEngine.UnityObjectExtends.ResetPRS)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(UnityEngine.GameObject), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE2(SEngine.UnityObjectExtends.ResetPRS)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
