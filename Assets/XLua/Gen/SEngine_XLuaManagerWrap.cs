...
namespace XLua.CSObjectWrap
{
    ...
    public class SEngineXLuaManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(SEngine.XLuaManager);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new SEngine.XLuaManager();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to SEngine.XLuaManager constructor!");
        ...
        static int _m_LoadLuaScriptsRes(RealStatePtr L)
        {
		    try {
                ...
                SEngine.XLuaManager gen_to_be_invoked = (SEngine.XLuaManager)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to SEngine.XLuaManager.LoadLuaScriptsRes!");
        ...
        static int _m_LoadLuaPBRes(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to SEngine.XLuaManager.LoadLuaPBRes!");
        ...
        static int _g_get_LuaReimport(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, SEngine.XLuaManager.LuaReimport);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_LuaReimport(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    SEngine.XLuaManager.LuaReimport = translator.GetDelegate<System.Action<string>>(L, 1);
