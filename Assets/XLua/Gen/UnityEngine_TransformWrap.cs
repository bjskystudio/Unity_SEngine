...
using SEngine;using DG.Tweening;
...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTransformWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 59, 19, 13);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ConvertLocalPositionToParent", _m_ConvertLocalPositionToParent);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "DoBezier2", _m_DoBezier2);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ConvertLocalPositionToParent(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Camera _cam = (UnityEngine.Camera)translator.GetObject(L, 2, typeof(UnityEngine.Camera));
                    UnityEngine.RectTransform _pRect = (UnityEngine.RectTransform)translator.GetObject(L, 3, typeof(UnityEngine.RectTransform));
                    
                        var gen_ret = gen_to_be_invoked.ConvertLocalPositionToParent( _cam, _pRect );
                        translator.PushUnityEngineVector3(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DoBezier2(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector3 _controlPos;translator.Get(L, 3, out _controlPos);
                    UnityEngine.Vector3 _endPos;translator.Get(L, 4, out _endPos);
                    float _during = (float)LuaAPI.lua_tonumber(L, 5);
                    
                        var gen_ret = gen_to_be_invoked.DoBezier2( _startPos, _controlPos, _endPos, _during );
                        translator.Push(L, gen_ret);
